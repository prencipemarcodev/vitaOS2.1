...
import { Rocket, LayoutDashboard, Calendar, Wallet, PiggyBank, Heart, FileSignature, StickyNote } from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      {(salary > 0 || bank > 0 || cash > 0) && (
        ...
        >
          {salary > 0 && (
            <div className="text-center p-3 rounded-[var(--radius-lg)] border border-[var(--border-subtle)]">
      ...
      >
        <div className="flex justify-center mb-2">
          <Rocket size={24} className="text-[var(--color-primary)]" />
        </div>
