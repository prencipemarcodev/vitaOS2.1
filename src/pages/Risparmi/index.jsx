          ...
          <div className="flex-1 min-h-0 lg:grid lg:grid-cols-3 lg:gap-6 lg:space-y-0 space-y-6">
            <div className="lg:col-span-2 flex flex-col lg:h-full min-h-0 order-2 lg:order-1">
              ...
              {plans.length === 0 ? (
                ...
                <div className="flex-1 min-h-0 grid grid-cols-1 sm:grid-cols-2 gap-4 auto-rows-max lg:overflow-y-auto pr-1 pb-4">
                  {plans.map(plan => (
                    <PlanCard
                      key={plan.id}
                      plan={plan}
            ...
            <div className="order-1 lg:order-2 lg:h-full lg:overflow-y-auto pr-1 pb-4">
              <SmartAdvicePanel />
            </div>
          </div>
        </div>
