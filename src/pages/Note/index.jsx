          ...
          <div className="flex items-center gap-2">
            <div className="relative max-lg:hidden">
              ...
              <input 
                ...
                className="bg-[var(--bg-base)] border rounded-[var(--radius-md)] pl-9 pr-4 py-1.5 text-xs w-48 focus:w-64 transition-all focus:outline-none"
                value={searchQuery}
        ...
        <div className="h-full flex flex-col pr-1">
          ...
          <div className="lg:hidden mb-4 relative">
            ...
            <input 
              type="text" 
              placeholder="Cerca note..." 
              className="w-full bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-2xl pl-11 pr-4 py-3 text-sm shadow-sm"
              value={searchQuery}
              onChange={e => setSearchQuery(e.target.value)}
            />
          </div>
